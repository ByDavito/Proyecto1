...
namespace Proyecto1.Migrations
{
    ...
    [Migration("20241122134502_Migracion13")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proyecto1.Models.Evento", b =>
                {
                    b.Property<int>("EventoID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Proyecto1.Models.Lugar", b =>
                {
                    b.Property<int>("LugarID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Proyecto1.Models.Persona", b =>
                {
                    b.Property<int>("PersonaID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Proyecto1.Models.Persona_tipoEjercicio", b =>
                {
                    b.Property<int>("relacionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("relacionID"));
                    ...
                    b.ToTable("Persona_tipoEjercicio");
                });
            ...
            modelBuilder.Entity("Proyecto1.Models.EjercicioFisico", b =>
                {
                    b.HasOne("Proyecto1.Models.Evento", "Evento")
                        .WithMany("EjerciciosFisicos")
                        .HasForeignKey("EventoID");

                    b.HasOne("Proyecto1.Models.Lugar", "Lugar")
                        .WithMany("EjerciciosFisicos")
                        .HasForeignKey("LugarID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Proyecto1.Models.Persona", "Persona")
                        .WithMany("EjerciciosFisicos")
            ...
            modelBuilder.Entity("Proyecto1.Models.Persona_tipoEjercicio", b =>
                {
                    b.HasOne("Proyecto1.Models.Persona", "Persona")
                        .WithMany("Persona_TipoEjercicos")
                        .HasForeignKey("PersonaID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Proyecto1.Models.Persona", b =>
                {
                    ...
                    b.Navigation("Persona_TipoEjercicos");
                });
